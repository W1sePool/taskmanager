...
public class DataInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        fromAddressRepository.save(new FromAddress("Vais123@rambler.ru"));
        fromAddressRepository.save(new FromAddress("Ivan@gmail.com"));
        fromAddressRepository.save(new FromAddress("Anna@gmail.com"));
        fromAddressRepository.save(new FromAddress("Vladimir@mail.ru"));
        toAddressRepository.save(new ToAddress("Alex@gmail.com"));
        toAddressRepository.save(new ToAddress("Ibm@gmail.com"));
        toAddressRepository.save(new ToAddress("local@gmail.com"));
